...
/**
 * __usePastLaunchesListQuery__
 *
 * To run a query within a React component, call `usePastLaunchesListQuery` and pass it any options that fit your needs.
 * When your component renders, `usePastLaunchesListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePastLaunchesListQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *   },
 * });
 */
export function usePastLaunchesListQuery(baseOptions: Apollo.QueryHookOptions<PastLaunchesListQuery, PastLaunchesListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PastLaunchesListQuery, PastLaunchesListQueryVariables>(PastLaunchesListDocument, options);
      }
export function usePastLaunchesListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PastLaunchesListQuery, PastLaunchesListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PastLaunchesListQuery, PastLaunchesListQueryVariables>(PastLaunchesListDocument, options);
        }
export type PastLaunchesListQueryHookResult = ReturnType<typeof usePastLaunchesListQuery>;
export type PastLaunchesListLazyQueryHookResult = ReturnType<typeof usePastLaunchesListLazyQuery>;
export type PastLaunchesListQueryResult = Apollo.QueryResult<PastLaunchesListQuery, PastLaunchesListQueryVariables>;